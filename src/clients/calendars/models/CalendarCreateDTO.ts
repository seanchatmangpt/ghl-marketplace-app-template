...
export type CalendarCreateDTO = {
  ...
  eventType?: CalendarCreateDTO.eventType;
  name: string;
  description?: string;
  slug?: string;
  widgetSlug?: string;
  calendarType?: CalendarCreateDTO.calendarType;
  /**
   * Calendar widget type. Choose "default" for "neo" and "classic" for "classic" layout.
   */
  widgetType?: CalendarCreateDTO.widgetType;
  eventTitle?: string;
  eventColor?: string;
  meetingLocation?: string;
  slotDuration?: number;
  preBufferUnit?: CalendarCreateDTO.preBufferUnit;
  slotInterval?: number;
  slotBuffer?: number;
  preBuffer?: number;
  /**
  ...
  notes?: string;
  pixelId?: string;
  formSubmitType?: CalendarCreateDTO.formSubmitType;
  formSubmitRedirectURL?: string;
  formSubmitThanksMessage?: string;
  availabilityType?: CalendarCreateDTO.availabilityType;
  /**
   * This is only to set the custom availability. For standard availability, use the openHours property
   */
  availabilities?: Array<Availability>;
  guestType?: CalendarCreateDTO.guestType;
  consentLabel?: string;
  calendarCoverImage?: string;
};
export namespace CalendarCreateDTO {
