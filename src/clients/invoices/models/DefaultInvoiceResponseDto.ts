...
export type DefaultInvoiceResponseDto = {
  /**
   * Invoice Id
   */
  _id: string;
   ...
   * Invoice Status
   */
  status: DefaultInvoiceResponseDto.status;
  /**
   * Live Mode
   */
  liveMode: boolean;
   ...
   */
  altId: string;
  altType: DefaultInvoiceResponseDto.altType;
  /**
   * Name of the invoice
   */
  name: string;
...
export namespace DefaultInvoiceResponseDto {
  /**
   * Invoice Status
   */
  export enum status {
