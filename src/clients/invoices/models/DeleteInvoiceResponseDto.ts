...
export type DeleteInvoiceResponseDto = {
  /**
   * Invoice Id
   */
  _id: string;
   ...
   * Invoice Status
   */
  status: DeleteInvoiceResponseDto.status;
  /**
   * Live Mode
   */
  liveMode: boolean;
   ...
   */
  altId: string;
  altType: DeleteInvoiceResponseDto.altType;
  /**
   * Name of the invoice
   */
  name: string;
...
export namespace DeleteInvoiceResponseDto {
  /**
   * Invoice Status
   */
  export enum status {
