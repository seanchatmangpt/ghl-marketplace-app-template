...
export type CreateLocationSuccessfulResponseDto = {
  /**
   * Location Id
   */
  id?: string;
   ...
   */
  country?: CreateLocationSuccessfulResponseDto.country;
  /**
...
export namespace CreateLocationSuccessfulResponseDto {
  /**
   * The country in which the business is present for which sub-account is created
   */
  export enum country {
